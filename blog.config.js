...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lilian', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '终身成长者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://thinkful.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Lilian 的博客', // 网站关键词 英文逗号隔开
